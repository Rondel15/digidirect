...
class BuyerCancelNegotiableQuoteTemplateTest extends WebapiAbstract
{
     ...
     * @dataProvider dataTestTemplateStatusCancel
     */
    #[
    ...
    public function testBuyerCancelNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/cancel/me',
        ...
        $this->assertEquals(TemplateInterface::STATUS_CANCELED, $quoteTemplate->getStatus());
    }

    /**
     * @return array[]
     */
    public static function dataTestTemplateStatusCancel(): array
    {
        return [
