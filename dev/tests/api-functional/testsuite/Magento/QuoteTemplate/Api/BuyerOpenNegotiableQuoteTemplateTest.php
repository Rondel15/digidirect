...
class BuyerOpenNegotiableQuoteTemplateTest extends WebapiAbstract
{
    ...
    #[
        ...
        DataFixture(
            ...
            [
                ...
                TemplateInterface::STATUS => TemplateInterface::STATUS_CREATED_BY_SELLER,
            ],
            'template'
        ),

    ]
    public function testOpenCreatedNegotiableQuoteTemplate(): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/open/me',
        ...
        $quoteTemplate = $this->quoteTemplateRepository->getById($template->getTemplateId());
        $this->assertEquals(TemplateInterface::STATUS_PROCESSING_BY_BUYER, $quoteTemplate->getStatus());
    }
    ...
    public function testOpenSubmittedNegotiableQuoteTemplate(): void
    {
        $customer = DataFixtureStorageManager::getStorage()->get('customer');
        $template = DataFixtureStorageManager::getStorage()->get('template');
        $token = $this->customerTokenService->createCustomerAccessToken($customer->getEmail(), 'password');
     ...
     * @dataProvider dataTestTemplateStatusOpen
     */
    #[
        Config('btob/website_configuration/company_active', 1),
        Config('btob/website_configuration/negotiablequote_active', 1),
    ...
    public function testBuyerOpenExistingNegotiableQuoteTemplateStatusChecks(
        string $status,
     ...
     * @return array[]
     */
    public static function dataTestTemplateStatusOpen(): array
    {
        return [
