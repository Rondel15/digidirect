...
class BuyerDeleteNegotiableQuoteTemplateTest extends WebapiAbstract
{
     ...
     * @dataProvider dataTestTemplateStatusDelete
     */
    #[
    ...
    public function testBuyerDeleteNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/me/' . $template->getTemplateId(),
        ...
        if ($expectException) {
            ...
            $this->expectExceptionMessage('Deletion is not allowed on template id');
        }
        ...
        if ($expectException) {
            ...
            $this->quoteTemplateRepository->getById((int)$template->getId());
        }
    }
     ...
     * @return array[]
     */
    public static function dataTestTemplateStatusDelete(): array
    {
        return [
