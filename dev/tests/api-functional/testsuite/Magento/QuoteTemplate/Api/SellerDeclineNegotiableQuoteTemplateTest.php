...
class SellerDeclineNegotiableQuoteTemplateTest extends WebapiAbstract
{
     ...
     * @dataProvider dataTestTemplateStatusDecline
     */
    #[
    ...
    public function testSellerDeclineNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/decline',
    ...
    public function testSellerDeclineNegotiableQuoteTemplateFailureWithoutReason(): void
    {
        $adminUser = DataFixtureStorageManager::getStorage()->get('user');
        $template = DataFixtureStorageManager::getStorage()->get('template');
        $token = $this->adminTokens->createAdminAccessToken(
        ...
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('is required. Enter and try again.');
        $this->_webApiCall(
            $serviceInfo,
            [
     ...
     * @return array[]
     */
    public static function dataTestTemplateStatusDecline(): array
    {
        return [
