...
class BuyerUpdateNegotiableQuoteTemplateTest extends WebapiAbstract
{
    ...
    public function testBuyerUpdatesNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/me',
        ...
        if (!$expectException) {
            ...
            self::assertEquals(30, $quoteTemplate->getMinOrders());
            self::assertEquals(70, $quoteTemplate->getMaxOrders());
            self::assertFalse($quoteTemplate->getIsMinMaxQtyUsed());
