...
class SellerCancelNegotiableQuoteTemplateTest extends WebapiAbstract
{
    ...
    public function testSellerCancelNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/cancel',
