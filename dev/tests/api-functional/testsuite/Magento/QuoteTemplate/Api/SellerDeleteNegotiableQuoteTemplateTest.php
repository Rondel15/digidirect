...
class SellerDeleteNegotiableQuoteTemplateTest extends WebapiAbstract
{
    ...
    public function testSellerDeleteNegotiableQuoteTemplate(string $status, bool $expectException): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/' . $template->getTemplateId(),
