...
class SellerOpenNegotiableQuoteTemplateTest extends WebapiAbstract
{
    ...
    #[
        ...
        DataFixture(
            ...
            [
                ...
                TemplateInterface::STATUS => TemplateInterface::STATUS_CREATED_BY_BUYER,
            ],
            'template'
        ),
    ]
    public function testAdminOpenCreatedNegotiableQuoteTemplate(): void
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/negotiableQuoteTemplate/open',
        ...
        $this->assertEquals(TemplateInterface::STATUS_PROCESSING_BY_SELLER, $quoteTemplate->getStatus());
    }
    ...
    public function testAdminOpenExistingNegotiableQuoteTemplate(): void
    {
        /** @var TemplateInterface $template */
        $template = DataFixtureStorageManager::getStorage()->get('template');
        $adminUser = DataFixtureStorageManager::getStorage()->get('user');
    ...
    public function testAdminOpenExistingNegotiableQuoteTemplateStatusChecks(
        string $status,
