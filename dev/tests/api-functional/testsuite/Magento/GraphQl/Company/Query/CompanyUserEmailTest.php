...
class CompanyUserEmailTest extends GraphQlAbstract
{
    ...
    #[
        ...
        DataFixture(
            ...
            [
                ...
                'super_user_id' => '$company_admin_ab.id$'
            ],
            'company_a',
        ),
        DataFixture(
            ...
            [
                'sales_representative_id' => '$user.id$',
                'super_user_id' => '$company_admin_b.id$'
            ],
            'company_b',
        ),
        DataFixture(
     ...
     */
    public function testCompanyUserEmailValid(
        ...
        self::assertEquals($isEmailAvailable, $response['isCompanyUserEmailAvailable']['is_email_available']);
    }
    ...
    public function isEmailAvailableDataProvider(): array
    {
        return [
            ...
            'emailNotAvailable_customer_a' => [
                'isEmailAvailable' => false,
                'email' => '',
                'customer' => 'company_customer_a',
                'companyContext' => 'company_a'
            ],
            'emailNotAvailable_customer_a_default_company' => [
                'isEmailAvailable' => false,
                'email' => '',
                'customer' => 'company_customer_a',
                'companyContext' => ''
     ...
     */
    public function testCompanyUserEmailCheckerFailures(string $email, string $expectedMessage, bool $login): void
    {
    ...
    public function testFailureDataProvider(): array
    {
        return [
            'email_missing' => [
                'email' => '',
                'expectedMessage' => 'Field "isCompanyUserEmailAvailable" argument "email" of type "String!" ' .
    ...
    public function testCompanyInActive(): void
    {
        ...
        $query = $this->getQuery('company-admin@example.com');
    ...
    private function getQuery($email)
    {
        ...
        return <<<QUERY
{
    isCompanyUserEmailAvailable $emailInput {
      is_email_available
    }
}
QUERY;
