...
class SetNegotiableQuoteBillingAddressTest extends GraphQlAbstract
{
    ...
    public function testMutation(
        ...
        if (!$exception) {
            ...
            $this->assertArrayHasKey('uid', $response['setNegotiableQuoteBillingAddress']['quote']);
            $this->assertEquals($quoteMask, $response['setNegotiableQuoteBillingAddress']['quote']['uid']);
            $this->assertArrayHasKey('billing_address', $response['setNegotiableQuoteBillingAddress']['quote']);
            $this->assertNotEmpty($response['setNegotiableQuoteBillingAddress']['quote']['billing_address']);
            $this->assertEquals($address, $response['setNegotiableQuoteBillingAddress']['quote']['billing_address']);
        }
    }
