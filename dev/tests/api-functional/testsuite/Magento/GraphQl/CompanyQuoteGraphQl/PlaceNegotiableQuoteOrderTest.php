...
use Magento\NegotiableQuote\Test\Fixture\NegotiableQuotePaymentMethod;
use Magento\NegotiableQuote\Test\Fixture\NegotiableQuoteShippingAddress;
use Magento\NegotiableQuote\Test\Fixture\NegotiableQuoteShippingMethod;
...
class PlaceNegotiableQuoteOrderTest extends GraphQlAbstract
{
    ...
    #[
        ...
        ConfigFixture('btob/website_configuration/purchaseorder_enabled', true),
        ...
        DataFixture(
            NegotiableQuotePaymentMethod::class,
            [
                NegotiableQuotePaymentMethod::QUOTE_ID => '$quote_one.id$',
            ]
        ),
        DataFixture(
            NegotiableQuoteShippingMethod::class,
            [
                NegotiableQuoteShippingMethod::QUOTE_ID => '$quote_one.id$',
            ]
        ),
        DataFixture(
        ...
        DataFixture(
            NegotiableQuotePaymentMethod::class,
            [
                NegotiableQuotePaymentMethod::QUOTE_ID => '$quote_two.id$',
            ]
        ),
        DataFixture(
            NegotiableQuoteShippingMethod::class,
            [
                NegotiableQuoteShippingMethod::QUOTE_ID => '$quote_two.id$',
            ]
        ),
        DataFixture(
            AssignCompanyToQuote::class,
    ...
    public function testMutation(
        ...
        if (!$exception) {
            $response = $this->graphQlMutation(
                $this->getNegotiableQuoteStatusQuery(
                    $quoteMask
                ),
                [],
                '',
