...
class AcceptNegotiableQuoteTemplateTest extends GraphQlAbstract
{
    /**
    ...
    public function testAcceptNegotiableQuoteTemplate()
    {
        ...
        $expectedStatusLabel = $this->statusProvider->getStatusLabel(TemplateInterface::STATUS_ACTIVE);
        $this->assertEquals(
            $expectedStatusLabel,
            $response['acceptNegotiableQuoteTemplate']['status']
        );
    }
