...
class GenerateNegotiableQuoteFromNegotiableQuoteTemplateTest extends GraphQlAbstract
{
    /**
    ...
    public function testGenerateNegotiableQuoteFromQuoteTemplate()
    {
        ...
        $this->assertEquals($customer->getEmail(), $response['negotiableQuote']['email']);
        $this->assertEquals(
            $parentQuote->getGrandTotal(),
    ...
    public function testGenerateNegotiableQuoteFromInactiveQuoteTemplate()
    {
        $quoteTemplate = DataFixtureStorageManager::getStorage()->get('template');
        $templateId = $quoteTemplate->getTemplateId();
        $customer = DataFixtureStorageManager::getStorage()->get('customer');
        ...
        $this->expectExceptionMessage('The template cannot generate quotes at the moment.');
