...
QUERY;
     ...
     * @return array|array[]
     */
    public static function dataProviderNegotiableQuotes(): array
    {
        return [
            'negotiableQuotes'=> [
                'negotiableQuoteData' =>[
...
QUERY;
     ...
     * @return array
     */
    public static function dataProviderNegotiableQuoteIdsQuoteNames(): array
    {
        return [
            'empty_quote_uids' => [
                false,
     ...
     * @return array
     */
    public static function dataProviderNegotiableQuoteSortOrder(): array
    {
        return [
            'sort_asc_by_name' => [
                'QUOTE_NAME',
     ...
     * @return array
     */
    public static function dataProviderNegotiableQuoteSortOrderWithFilter(): array
    {
        return [
            'sort_asc_by_name' => [
                'QUOTE_NAME',
...
QUERY;
     ...
     * @return array
     */
    public static function dataProviderInvalidNegotiableQuoteIds(): array
    {
        return [
...
QUERY;
     ...
     * @return array
     */
    public static function dataProviderInvalidNegotiableQuoteName(): array
    {
        return [
            'invalid_quote_name' => [
                '123$%#$'
