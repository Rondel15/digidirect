...
class SendNegotiableQuoteForReviewTest extends GraphQlAbstract
{
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteWithComment(): void
    {
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteWithoutComment(): void
    {
        $response = $this->graphQlMutation($this->getQuery('nq_customer_mask', ''), [], '', $this->getHeaderMap());
     ...
     */
    public function SendNegotiableQuoteWithInvalidCustomerToken(
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteWithNoCustomerToken(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteNoModuleEnabled(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteCustomerNoCompany(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteNoCompanyFeatureEnabled(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteNoManagePermissions(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteUnownedQuote(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteNonNegotiable(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage(
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteBadStatus(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage(
            'The quotes with the following UIDs have a status that does not allow them to be edited or submitted: '
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteForInvalidNegotiableQuoteId(): void
    {
        $this->expectException(Exception::class);
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteForSecondStore(): void
    {
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteForInvalidWebsite(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('Could not find a quote with the specified UID.');
     ...
     * @throws Exception
     */
    public function SendNegotiableQuoteAfterProductRemovedFromQuote()
    {
...
MUTATION;
        ...
        $sendForReviewResponse = $this->graphQlMutation(
            $this->getQuery('nq_customer_mask', 'Comment after removing an item'),
            [],
            '',
            $this->getHeaderMap()
        );
