...
/**
 * Test validate purchase orders when rules apply
 */
#[
...
class ValidateWhenRulesApplyTest extends GraphQlAbstract
{
...
QRY;
    ...
    /**
     * A PO in PENDING status turns out into APPROVAL REQUIRED when rules apply and requires approval from a user.
     *
     * @return void
     * @throws AuthenticationException
     * @throws LocalizedException
     */
    public function testValidatePurchaseOrderInPendingStatusWhenRulesApplyAndRequiresApprovalFromAUser()
    {
        $expectedResult = [
