...
class ApproveTest extends GraphQlAbstract
{
...
QRY;
     ...
     * @throws Exception
     */
    public function testAttemptToApprovePurchaseOrdersByNonAuthorizedUser()
    {
     ...
     */
    public function testAttemptToApproveNonExistingPurchaseOrder()
    {
        $nonExistingPurchaseOrdersIds = ["90000001", "90000002"];

        $expectedMessage = "Action 'approve' - purchase order with requested ID=%s not found";
     ...
     * @throws LocalizedException
     */
    public function testApprovePendingPurchaseOrders()
    {
     ...
     */
    public function testAttemptToApproveApprovedPurchaseOrders()
    {
        /** @var PurchaseOrderInterface $purchaseOrder */
        $purchaseOrder = DataFixtureStorageManager::getStorage()->get('purchase_order');
        ...
        $expectedMessage = sprintf(
            "Action 'approve' is not allowed for purchase order %s.",
