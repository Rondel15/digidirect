 ...
 */
class PlacePurchaseOrderTest extends GraphQlAbstract
{
    /**
     * @var Encoder
     */
    ...
    public function testPlacePurchaseOrder()
    {
        ...
        $purchaseOrder = $purchaseOrderRepository->getById(
            $this->encoder->decode($result['placePurchaseOrder']['purchase_order']['uid'])
        );
    ...
    public function testSuccessfulPONegotiableQuote()
    {
        /** @var \Magento\Quote\Model\QuoteIdMask $quote */
        $maskedQuoteId = DataFixtureStorageManager::getStorage()->get('quoteIdMask')->getMaskedId();

        /** @var $quoteCompanyAdmin */
        $quoteCompanyAdmin = DataFixtureStorageManager::getStorage()->get('quote');

        /** @var $negotiableQuoteCompanyAdmin */
        $negotiableQuoteCompanyAdmin = $this->negotiableQuoteRepository->getById($maskedQuoteId);
         ...
         */
        $negotiableQuote = $quoteCompanyAdmin->getExtensionAttributes()->getNegotiableQuote();
        $negotiableQuote->setQuoteName('Quote 1');
        $negotiableQuote->setQuoteId($negotiableQuoteCompanyAdmin->getQuoteId());
        ...
        /**
         * Approve the negotiable quote as admin
         */
        $negotiableQuote = $quoteCompanyAdmin->getExtensionAttributes()->getNegotiableQuote();
        ...
        /**
         * Invoke the placePurchaseOrder mutation
         */
        $result = $this->graphQlMutation(
            $this->getQuery($maskedQuoteId),
            [],
    ...
    public function testFailPOInactiveCart()
    {
