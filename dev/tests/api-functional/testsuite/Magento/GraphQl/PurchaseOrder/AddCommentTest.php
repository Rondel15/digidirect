...
QRY;
    ...
    /**
     * Check purchase order query consist created_at date
     *
     * @return void
     * @throws AuthenticationException
     * @throws LocalizedException
    ...
    public function testCheckAddedCommentConsistCreatdAt()
    {
        $QUERY = <<<QRY
mutation {
    addPurchaseOrderComment(input: {purchase_order_uid: "%s", comment: "Lorem ipsum dolor sit amet"}) {
...
QRY;
        ...
        $this->assertNotEmpty($response["addPurchaseOrderComment"]);
        $this->assertArrayHasKey('created_at', $response["addPurchaseOrderComment"]["comment"]);
    }
