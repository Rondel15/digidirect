...
{
    public const SERVICE_READ_NAME = 'companyAclV1';
    ...
    /**
     * Test assignRoles with wrong company in context via WebAPI.
     *
     * @return void
     * @magentoApiDataFixture Magento/NegotiableQuote/_files/company_customer.php
     */
    public function testAssignRolesWrongCompanyContext()
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                ...
                . '"parameters":{"fieldName":"role_id","value":%s}}',
                $role->getId()
            )
        );
        $this->_webApiCall($serviceInfo, $requestData);
