...
return [
    [
        'permissions' => [
            ...
            'Magento_NegotiableQuote::manage_quotes_sub' => 'deny',
            'Magento_NegotiableQuote::view_quotes_sub' => 'deny',
            'Magento_NegotiableQuote::edit_quotes_sub' => 'deny',
            'Magento_NegotiableQuote::delete_quotes_sub' => 'deny',
            'Magento_NegotiableQuoteTemplate::all' => 'allow',
            'Magento_NegotiableQuoteTemplate::view_template' => 'allow',
            'Magento_NegotiableQuoteTemplate::manage' => 'allow',
            'Magento_NegotiableQuoteTemplate::generate_quote' => 'allow',
            'Magento_NegotiableQuoteTemplate::manage_quote_templates_sub' => 'deny',
            'Magento_NegotiableQuoteTemplate::view_quote_templates_sub' => 'deny',
            'Magento_NegotiableQuoteTemplate::edit_quote_templates_sub' => 'deny',
            'Magento_NegotiableQuoteTemplate::delete_quote_templates_sub' => 'deny',
