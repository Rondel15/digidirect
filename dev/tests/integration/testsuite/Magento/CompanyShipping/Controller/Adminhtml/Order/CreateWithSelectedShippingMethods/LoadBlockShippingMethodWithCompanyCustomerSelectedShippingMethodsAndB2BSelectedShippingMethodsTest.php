...
use Magento\CompanyShipping\Controller\Adminhtml\Order\CreateWithSelectedShippingMethodsAbstract as ParentT;
 ...
 */
class LoadBlockShippingMethodWithCompanyCustomerSelectedShippingMethodsAndB2BSelectedShippingMethodsTest extends ParentT
{
    /**
    ...
    public function testLoadBlockShippingMethodWithCompanyCustomerSelectedShippingMethodsAndB2BSelectedShippingMethods(
        ...
        $this->_objectManager->get(ShippingMethodRepository::class)->save($companyShippingSettings);
