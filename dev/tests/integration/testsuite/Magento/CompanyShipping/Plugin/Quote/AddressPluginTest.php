...
use Magento\CompanyShipping\Model\Company\ShippingMethodRepository;
...
class AddressPluginTest extends TestCase
{
    ...
    public function testCompanyCustomerStoreFrontWithB2BShippingMethodsAndAllShippingMethods(
        ...
        $this->objectManager->get(ShippingMethodRepository::class)->save($companyShippingSettings);
     ...
     * @return array
     */
    public static function shippingConfigDataProviderWithAllShippingMethodsEnabled()
    {
        return [
            'defaultScope' => [
                'configData' => [
     ...
     * @return array
     */
    public static function shippingConfigDataProviderWithSelectedShippingMethodsEnabled()
    {
        return [
          'defaultScope' => [
              'configData' => [
     ...
     * @return array
     */
    public static function shippingConfigDataProviderWithSelectedDisabledShippingMethods()
    {
        return [
          'defaultScope' => [
              'configData' => [
