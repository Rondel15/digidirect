...
class DataProviderTest extends TestCase
{
    ...
    public function tearDown(): void
    {
        ...
        foreach ([
             ...
             PermissionsConfig::XML_PATH_ENABLED,
             PermissionsConfig::XML_PATH_GRANT_CATALOG_CATEGORY_VIEW,
             PermissionsConfig::XML_PATH_GRANT_CATALOG_PRODUCT_PRICE,
             PermissionsConfig::XML_PATH_GRANT_CHECKOUT_ITEMS,
        ] as $configPath) {
