...
class HistoryPluginTest extends AbstractController
{
    ...
    /**
     * @var CompanyCustomerAssignmentInterface
     */
    private $companyCustomerAssignment;
    ...
    protected function setUp(): void
    {
        ...
        $this->companyCustomerAssignment = $this->objectManager->get(CompanyCustomerAssignmentInterface::class);
    ...
    public function testMyOrdersGridShowsNonCompanyOrderAndCompanyOrderForCustomerAfterCustomerJoinsCompany()
    {
        ...
        // re-login to set the company id in the customer session,
        // which ultimately sets the company context for viewing orders
        $this->loginAsCustomer($customer);
    ...
    public function testMyOrdersGridShowsOnlyNonCompanyOrderForCustomerAfterCustomerJoinsASecondCompany()
    {
        ...
        $this->companyCustomerAssignment->unassignCustomer((int) $companyId, (int) $customer->getId());
