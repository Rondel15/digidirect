...
{
    private const URI = 'purchaseorder/purchaseorder/index';
     ...
     * @return array
     */
    public static function indexActionAsCompanyUserDataProvider()
    {
        return [
            'view_purchase_order_grid' => [
                'companyUserEmail' => 'veronica.costello@example.com',
                'companyPurchaseOrdersConfigEnabled' => 1,
                'purchaseOrdersPermissionValue' => PermissionInterface::ALLOW_PERMISSION,
            ...
            'view_purchase_order_grid_without_permission' => [
                'companyUserEmail' => 'veronica.costello@example.com',
                'companyPurchaseOrdersConfigEnabled' => 1,
                'purchaseOrdersPermissionValue' => PermissionInterface::DENY_PERMISSION,
            ...
            'view_purchase_order_grid_without_company_purchase_orders_enabled' => [
                'companyUserEmail' => 'veronica.costello@example.com',
                'companyPurchaseOrdersConfigEnabled' => 0,
                'purchaseOrdersPermissionValue' => PermissionInterface::ALLOW_PERMISSION,
                'expectedHttpResponseCode' => 302,
                'expectedRedirect' => 'company/accessdenied'
            ]
