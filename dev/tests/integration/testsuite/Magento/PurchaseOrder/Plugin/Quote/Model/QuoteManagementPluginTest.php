...
class QuoteManagementPluginTest extends TestCase
{
     ...
     * @return array
     */
    public static function afterSubmitDataProvider()
    {
        return [
            /*
            ...
            'deferredPaymentMethod' => [
                'purchaseOrderStatus' => PurchaseOrderInterface::STATUS_APPROVED_PENDING_PAYMENT,
                'initialPaymentMethod' => 'paypal_express',
                'finalPaymentMethod' => 'checkmo',
                'expectUpdate' => true
            ],
            /*
            ...
            'nonDeferredPaymentMethod' => [
                'purchaseOrderStatus' => PurchaseOrderInterface::STATUS_APPROVED,
                'initialPaymentMethod' => 'checkmo',
                'finalPaymentMethod' => 'checkmo',
                'expectUpdate' => false
            ]
        ];
