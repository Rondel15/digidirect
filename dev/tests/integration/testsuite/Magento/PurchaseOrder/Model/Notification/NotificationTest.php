...
class NotificationTest extends AbstractTestCase
{
     ...
     * @return array
     */
    public static function emailReplaceTemplateDataProvider()
    {
        return [
            [
     ...
     * @return array
     */
    public static function purchaseOrderActionDataProvider()
    {
        return [
    ...
    public static function paymentMethodsDataProvider()
    {
        return [
            ...
            'online_payment_method' => [
                ...
                'paymentMethodTitle' => 'PayPal Express Checkout'
            ]
        ];
    }
     ...
     * @return array
     */
    public static function negotiableQuoteMessageDataProvider()
    {
        return [
            'po_approval_required' => [
                'purchaserEmail' => 'alex.smith@example.com',
                'actionNotificationClass' => ApprovalRequired::class,
                'expectedMessage' => 'and is being processed.'
            ],
            'po_auto_approved' => [
                'purchaserEmail' => 'john.doe@example.com',
                'actionNotificationClass' => AutoApproved::class,
                'expectedMessage' => 'This Purchase Order has been approved automatically.'
            ]
        ];
    }
     ...
     * @return array[]
     */
    public static function purchaseOrderAutoApprovedRulesBasedDataProvider()
    {
        return [
            'offline_payment_method' => [
                'customerEmail' => 'alex.smith@example.com',
                'paymentMethodCode' => 'checkmo',
                'expectedStatus' => PurchaseOrderInterface::STATUS_APPROVED,
                'expectedEmailDetails' => [
            ...
            'online_payment_method' => [
                'customerEmail' => 'alex.smith@example.com',
                'paymentMethodCode' => 'paypal_express',
                'expectedStatus' => PurchaseOrderInterface::STATUS_APPROVED_PENDING_PAYMENT,
                'expectedEmailDetails' => [
                    'content' => 'has been created and approved automatically.',
