...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function viewPurchaseOrderPermissionsDataProvider()
    {
        return [
            'no view' => [[]],
    ...
    public function testPurchaseOrderResultsWithoutViewPermission()
    {
        ...
        $this->assertCustomerHasExpectedResultsOnCurrentCustomerFilterCollection(
            [
                'customer_id' => $defaultUserWithSubordinates->getId(),
                'expected_purchase_order_ids' => []
            ]
     ...
     * @param string $scenarioName
     */
    private function assertCustomerHasExpectedResultsOnCurrentCustomerFilterCollection(
        array $scenarioData,
        string $scenarioName = ''
    ): void {
        $customerId = $scenarioData['customer_id'];
        ...
        /** @var Collection $purchaseOrderCollection */
        $purchaseOrderCollection = Bootstrap::getObjectManager()->create(
            Collection::class,
            ['filterCurrentCustomer' => true]
        );
