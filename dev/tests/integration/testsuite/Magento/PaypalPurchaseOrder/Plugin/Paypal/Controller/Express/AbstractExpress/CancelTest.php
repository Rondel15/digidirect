...
class CancelTest extends AbstractController
{
     ...
     * @return array
     */
    public static function expectedRedirectPathDataProvider()
    {
        return [
            'po_checkout' => [
                'purchaseOrderId' => 'fixture',
                'customerEmail' => 'alex.smith@example.com',
                'creatorEmail' => 'alex.smith@example.com',
                'expectedRedirectUri' => 'purchaseorder/purchaseorder/view/request_id'
            ],
            'po_checkout_absent_po_id' => [
                'purchaseOrderId' => null,
                'customerEmail' => 'alex.smith@example.com',
                'creatorEmail' => 'alex.smith@example.com',
                'expectedRedirectUri' => 'checkout/cart'
            ],
