...
abstract class AbstractCreateTest extends AbstractBackendController
{
    ...
    private function preformTestCompanyCreateOrderPaymentMethods(
        ...
        $nonCompanyCustomer = $this->_objectManager->get(CustomerRepositoryInterface::class)
        ...
        $this->_objectManager->get(PaymentMethodRepository::class)->save($companyPaymentSettings);
