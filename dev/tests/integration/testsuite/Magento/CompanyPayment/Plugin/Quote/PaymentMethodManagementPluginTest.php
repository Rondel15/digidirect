...
use Magento\CompanyPayment\Model\Company\PaymentMethodRepository;
...
class PaymentMethodManagementPluginTest extends TestCase
{
     ...
     */
    private $companyPaymentMethodsRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->companyPaymentMethodsRepository = $this->objectManager->get(PaymentMethodRepository::class);
    }
    ...
    private function performTestCompanyStoreFrontPaymentMethods(
        ...
        $this->companyPaymentMethodsRepository->save($companyPaymentSettings);
