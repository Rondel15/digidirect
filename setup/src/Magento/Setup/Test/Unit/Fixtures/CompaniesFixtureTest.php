    ...
    public function testExecute($addCustomers, $websiteId, array $sequence, array $calls): void
    {
        ...
        $this->fixtureModelMock->method('getValue')
            ->willReturnCallback(function (
                ...
                if ($arg1 == 'companies' && $arg2 == 0) {
                    return $companiesCount;
                } elseif ($arg1 == 'user_roles_per_company' && $arg2 == 0) {
                    return $userRolesPerCompanyCount;
                } elseif ($arg1 == 'customers' && $arg2 == 0) {
                    return $customersCount;
                } elseif ($arg1 == 'teams_per_company' && $arg2 == 0) {
                    return $teamsPerCompanyCount;
                }
            });
